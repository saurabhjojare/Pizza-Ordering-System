                    ...
                    {isAdminPage && !isAddPizzaPage && (
                        <>
                            <li className="nav-item">
                                <Link className={`nav-link ${location.pathname === '/pizza' ? 'active' : ''}`}
                                    to="/pizza">Pizza</Link>
                            </li>
                            <li className="nav-item">
                                <Link className={`nav-link ${location.pathname === '/customer' ? 'active' : ''}`}
                                    to="/customer">Customer</Link>
                            </li>
                            <li className="nav-item">
                                <Link className={`nav-link ${location.pathname === '/order' ? 'active' : ''}`}
                                    to="/order">Order</Link>
                            </li>
                        </>
                    )}
