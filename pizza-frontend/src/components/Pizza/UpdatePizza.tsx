        ...
        <div className="col-lg-6 col-md-8 col-sm-10">
          ...
          <Formik
            ...
            onSubmit={async (values) => {
              try {
                const response = await axios.patch(`http://localhost:5000/api/v1/pizzas/${pizzaId}`, values);
            ...
            {() => (
              <Form className="needs-validation" noValidate>
                <div className="form-group mb-2">
                  ...
                  />
                  <ErrorMessage name="name" component="div" className="mt-2 text-danger" />
                </div>
                <div className="form-group mb-2">
                  ...
                  <ErrorMessage name="type" component="div" className="mt-2 text-danger" />
                </div>
                <div className="form-group mb-2">
                  ...
                  <Field
                    ...
                    className="form-control"
                  />
                  <ErrorMessage name="imageUrl" component="div" className="mt-2 text-danger" />
                </div>
                <div className="form-group mb-2">
                  ...
                  <Field
                    ...
                    rows={4}
                  />
                  <ErrorMessage name="description" component="div" className="mt-2 text-danger" />
                </div>
                <div className="form-group mb-2">
                  ...
                  <Field
                    ...
                    className="form-control"
                  />
                  <ErrorMessage name="regularPrice" component="div" className="mt-2 text-danger" />
                </div>
                <div className="form-group mb-2">
                  ...
                  <Field
                    ...
                    className="form-control"
                  />
                  <ErrorMessage name="mediumPrice" component="div" className="mt-2 text-danger" />
                </div>
                <div className="form-group mb-2">
                  ...
                  <Field
                    ...
                    className="form-control"
                  />
                  <ErrorMessage name="largePrice" component="div" className="mt-2 text-danger" />
                </div>
